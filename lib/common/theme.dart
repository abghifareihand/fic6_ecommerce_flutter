...
Color bgColor = const Color(0xffF7F6F4);
Color primaryColor = const Color(0xffFF5500);
Color secondaryColor = const Color(0xffFF5500).withOpacity(0.5);
Color whiteColor = const Color(0xffFFFFFF);
Color greyColor = const Color(0xff909090);
