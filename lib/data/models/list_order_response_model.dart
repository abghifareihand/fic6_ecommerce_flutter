...
class ListOrderResponseModel {
    ...
    factory ListOrderResponseModel.fromRawJson(String str) => ListOrderResponseModel.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory ListOrderResponseModel.fromJson(Map<String, dynamic> json) => ListOrderResponseModel(
